...
const GlassButton = React.forwardRef<HTMLButtonElement, GlassButtonProps>(
  ({ className, children, size, contentClassName, glassColor, ...props }, ref) => {
    ...
    // Built as a raw string and injected via dangerouslySetInnerHTML so React does
    // not HTML-escape the apostrophes / ampersands in the comments (which would
    // otherwise differ between the server and client render and trip a hydration
    // mismatch).
    const css = `
          .btn-liquid {
            appearance: none;
